    ...
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex items-center gap-2 mb-4">
          ...
          <h1 class="text-red-500 underline">Continental</h1>
        </div>

                      <div class="flex items-center gap-5 mb-3">
                        <div class="flex items-center gap-2">
                          <h1 class=""><Icon name="ph:currency-inr-bold"/> 44</h1>
                          <h1 class="text-slate-400 line-through"><Icon name="ph:currency-inr-bold"/> 55</h1>
                        </div>
        ...
        <p>Spinach Corn Filling, Paneer Bhurji, Baked Beans, Tomato Basil Salad</p>
